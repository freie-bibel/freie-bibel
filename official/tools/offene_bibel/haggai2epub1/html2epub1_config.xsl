...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/XMLBIBLE">
    <html2epub1-config>
      <xsl:comment> This file was generated by html2epub1_config.xsl of haggai2epub1 for Offene Bibel, which is free software licensed under the GNU Affero General Public License 3 or any later version (see https://github.com/free-scriptures/free-scriptures/ and http://www.free-scriptures.org). </xsl:comment>
      <in>
        <inFile title="Titel">./components/title.xhtml</inFile>
        ...
        <!--
          Path relative to $/official/tools/free-scriptures/tools/workflows/haggai2epub1/temp/,
          the location of the html2epub1_config.xml file.
        -->
        <inFile title="Lizenzbestimmungen">./../../../../../offene_bibel/license.xhtml</inFile>
