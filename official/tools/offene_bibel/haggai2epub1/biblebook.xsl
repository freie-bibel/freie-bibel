...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <xsl:template match="BIBLEBOOK">
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
      <xsl:comment> This file was generated by biblebook.xsl of haggai2epub1 for Offene Bibel, which is free software licensed under the GNU Affero General Public License 3 or any later version (see https://github.com/free-scriptures/free-scriptures/ and http://www.free-scriptures.org). </xsl:comment>
      <head>
        <title>
          <xsl:choose>
        ...
        <meta name="generator" content="biblebook.xsl of haggai2epub1 for Offene Bibel (http://www.free-scriptures.org)"/>
        ...
        <div id="id_{./@bnumber}">
          ...
          <div id="id_chapters">
            <p style="text-align: center;">
              <a href="title.xhtml#id_books">Bibelbücher</a>
            </p>
            <hr/>
            Kapitel:
          ...
          <xsl:if test="//CHAPTER//VERSE/NOTE">
            <div id="id_footnotes">
              ...
              <div style="text-align: center;">
                <a href="#id_chapters">Kapitel</a><br/>
                <a href="title.xhtml#id_books">Bibelbücher</a>
              </div>
            </div>
          </xsl:if>
