...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="XMLBIBLE">
    <xsl:comment> This file was generated by hag2ncx.xsl of hag2epub2 (http://www.freie-bibel.de). </xsl:comment>
    <ncx>
      <xsl:attribute name="xmlns">http://www.daisy.org/z3986/2005/ncx/</xsl:attribute>
      <xsl:attribute name="version">2005-1</xsl:attribute>
      <xsl:attribute name="xml:lang"><xsl:value-of select="/XMLBIBLE/INFORMATION/language"/></xsl:attribute>
      <head>
